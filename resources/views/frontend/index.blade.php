                        ...
                        <div class="intro-form">
                            <div class="intro-form-inner">
                                ...
                                <div class="banner-form">
                                    ...
                                    <a href="{{ url('/login') }}"><button class="">Find Your Partner</button></a>
...
{{--                                </ul>--}}
                ...
                <div class="col-lg-6">
                    <div class="banner-thumb">
                        <img src="{{ url('css/assets/images/banner/01.png') }}" alt="img">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="all-shapes">
        <img src="{{ url('css/assets/images/banner/banner-shapes/01.png') }}" alt="shape" class="banner-shape shape-1">
        <img src="{{ url('css/assets/images/banner/banner-shapes/02.png') }}" alt="shape" class="banner-shape shape-2">
        <img src="{{ url('css/assets/images/banner/banner-shapes/03.png') }}" alt="shape" class="banner-shape shape-3">
        <img src="{{ url('css/assets/images/banner/banner-shapes/04.png') }}" alt="shape" class="banner-shape shape-4">
        <img src="{{ url('css/assets/images/banner/banner-shapes/05.png') }}" alt="shape" class="banner-shape shape-5">
        <img src="{{ url('css/assets/images/banner/banner-shapes/06.png') }}" alt="shape" class="banner-shape shape-6">
        <img src="{{ url('css/assets/images/banner/banner-shapes/07.png') }}" alt="shape" class="banner-shape shape-7">
        <img src="{{ url('css/assets/images/banner/banner-shapes/08.png') }}" alt="shape" class="banner-shape shape-8">
    </div>
</section>
            ...
            <div class="row justify-content-center g-3 g-md-4">
                <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                    <div class="lab-item member-item style-1">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/member/01.jpg') }}" alt="member-img">
                            </div>
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                    <div class="lab-item member-item style-1">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/member/02.jpg') }}" alt="member-img">
                            </div>
                            <div class="lab-content">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                    <div class="lab-item member-item style-1">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/member/03.jpg') }}" alt="member-img">
                            </div>
                            <div class="lab-content">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                    <div class="lab-item member-item style-1">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/member/04.jpg') }}" alt="member-img">
                            </div>
                            <div class="lab-content">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                    <div class="lab-item member-item style-1">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/member/05.jpg') }}" alt="member-img">
                            </div>
                            <div class="lab-content">
                ...
                <div class="col-xl-2 col-lg-3 col-md-4 col-6">
                    <div class="lab-item member-item style-1">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/member/06.jpg') }}" alt="member-img">
                            </div>
                            <div class="lab-content">
            ...
            <div class="row justify-content-center g-4">
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="lab-item about-item">
                        <div class="lab-inner text-center">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/about/01.png') }}" alt="img">
                            </div>
                            <div class="lab-content">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="lab-item about-item">
                        <div class="lab-inner text-center">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/about/02.png') }}" alt="img">
                            </div>
                            <div class="lab-content">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                    <div class="lab-item about-item">
                        <div class="lab-inner text-center">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/about/03.png') }}" alt="img">
                            </div>
                            <div class="lab-content">
                                <h2 class="counter">29,960</h2>
                                <p>Men Online</p>
                        ...
                        <div class="lab-inner text-center">
                            <div class="lab-thumb">
                                <div class="thumb-inner">
                                    <img src="{{ url('css/assets/images/work/01.png')  }}" alt="work-img">
                                    <div class="step">
                                        <span>step</span>
                                        <p>01</p>
                                    </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12 px-4">
                    <div class="lab-item work-item">
                        <div class="lab-inner text-center">
                            <div class="lab-thumb">
                                <div class="thumb-inner">
                                    <img src="{{ url('css/assets/images/work/02.png') }}" alt="work-img">
                                    <div class="step">
                                        <span>step</span>
                                        <p>02</p>
                                    </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12 px-4">
                    <div class="lab-item work-item">
                        <div class="lab-inner text-center">
                            <div class="lab-thumb">
                                <div class="thumb-inner">
                                    <img src="{{ url('css/assets/images/work/03.png') }}" alt="work-img">
                                    <div class="step">
                                        <span>step</span>
                                        <p>03</p>
                                    </div>
            ...
            <div class="row justify-content-center g-4">
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="story-item lab-item">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/story/01.jpg') }}" alt="img">
                            </div>
                            <div class="lab-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="story-item lab-item">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/story/02.jpg') }}" alt="img">
                            </div>
                            <div class="lab-content">
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="story-item lab-item">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/story/03.jpg') }}" alt="img">
                            </div>
                            <div class="lab-content">
            ...
            <div class="grid-memberlist">
                ...
                <div class="grid-member filter-item girl">
                    <div class="lab-item member-item style-1 style-2">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/member/07.jpg') }}" alt="member-img">
                            </div>
                            <div class="lab-content">
                                <h6><a href="profile.html">Andrea Guido</a> </h6>
                                <p>Active 1 Day</p>
                ...
                <div class="grid-member filter-item boy">
                    <div class="lab-item member-item style-1 style-2">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/member/08.jpg') }}" alt="member-img">
                            </div>
                            <div class="lab-content">
                ...
                <div class="grid-member filter-item girl">
                    <div class="lab-item member-item style-1 style-2">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/member/09.jpg') }}" alt="member-img">
                            </div>
                            <div class="lab-content">
                ...
                <div class="grid-member filter-item boy">
                    <div class="lab-item member-item style-1 style-2">
                        <div class="lab-inner">
                            <div class="lab-thumb">
                                <img src="{{ url('css/assets/images/member/10.jpg') }}" alt="member-img">
                            </div>
                            <div class="lab-content">
            ...
            <div class="row g-4">
                    ...
                    <div class="group-item lab-item">
                        <div class="lab-inner d-flex flex-wrap align-items-center p-4">
                            <div class="lab-thumb me-sm-4 mb-4 mb-sm-0">
                                <img src="{{ url('css/assets/images/group/01.jpg') }}" alt="img">
                            </div>
                            <div class="lab-content">
                                ...
                                <ul class="img-stack d-flex">
                                    <li><img src="{{ url('css/assets/images/group/group-mem/01.png') }}" alt="member-img"></li>
                                    <li><img src="{{ url('css/assets/images/group/group-mem/02.png') }}" alt="member-img"></li>
                                    <li><img src="{{ url('css/assets/images/group/group-mem/03.png') }}" alt="member-img"></li>
                                    <li><img src="{{ url('css/assets/images/group/group-mem/04.png') }}" alt="member-img"></li>
                                    <li><img src="{{ url('css/assets/images/group/group-mem/05.png') }}" alt="member-img"></li>
                                    <li><img src="{{ url('css/assets/images/group/group-mem/06.png') }}" alt="member-img"></li>
                ...
                <div class="col-xl-6 col-12">
                    <div class="group-item lab-item">
                        <div class="lab-inner d-flex flex-wrap align-items-center p-4">
                            <div class="lab-thumb me-sm-4 mb-4 mb-sm-0">
                                <img src="{{ url('css/assets/images/group/02.jpg') }}" alt="img">
                            </div>
                            <div class="lab-content">
