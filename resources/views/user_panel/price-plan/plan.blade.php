                    ...
                    <article class="card__content grid">
                        <div class="card__pricing">
                            <div class="card__pricing-number">
                                <span class="card__pricing-symbol">$</span>{{ $plan->package_price }}
                            </div>
                            <span class="card__pricing-month">/{{ $plan->duration }}</span>
                        </div>
...
{{--                                <img src="assets/img/free-coin.png" alt="" class="card__header-img">--}}
                            ...
                            <span class="card__header-subtitle"><strong>{{ $plan->package_name }}</strong></span>
                            <h1 class="card__header-title">{{ $plan->sale_level }}</h1>
                        </header>

                        <ul class="card__list grid pl-0">
                            <li class="card__list-item">
                                <i class="uil uil-check card__list-icon"></i>
                                <p class="card__list-description"><i class="fa fa-check pr-10"></i>{{ $plan->messages }}</p>
                            </li>
                            <li class="card__list-item">
                                <i class="uil uil-check card__list-icon"></i>
                                <p class="card__list-description"><i class="fa fa-check pr-10"></i>{{ $plan->view_contact }}</p>
                            </li>
                            <li class="card__list-item">
                                <i class="uil uil-check card__list-icon"></i>
                                <p class="card__list-description"><i class="fa fa-check pr-10"></i>{{$plan->standout_profile}}</p>
                            </li>
                            <li class="card__list-item">
                                <i class="uil uil-check card__list-icon"></i>
                                <p class="card__list-description"><i class="fa fa-check pr-10"></i>{{ $plan->directly_contact }}</p>
                            </li>
                        </ul>
